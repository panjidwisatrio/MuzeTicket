...
function register($infologin)
{
    ...
    mysqli_query($conn, "INSERT INTO admin(role_id, nama_lengkap, email, password) VALUES(1,'$username', '$email', '$password')");
...
function login_check($data_login) {
    ...
    $check_user = mysqli_query($conn, "SELECT * FROM admin WHERE email = '$email'");
